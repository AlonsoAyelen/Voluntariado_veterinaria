# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-08-15 19:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prifesional', models.CharField(max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha', models.DateField()),
                ('urea', models.DecimalField(decimal_places=2, max_digits=5)),
                ('crea', models.DecimalField(decimal_places=2, max_digits=5)),
                ...
                ('alb', models.DecimalField(decimal_places=2, max_digits=5)),
                ('FAS', models.DecimalField(decimal_places=2, max_digits=5)),
                ('GGT', models.DecimalField(decimal_places=2, max_digits=5)),
                ('CPK', models.DecimalField(decimal_places=2, max_digits=5)),
                ('col', models.DecimalField(decimal_places=2, max_digits=5)),
                ('bil_t', models.DecimalField(decimal_places=2, max_digits=5)),
                ('bil_d', models.DecimalField(decimal_places=2, max_digits=5)),
                ('trig', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=True)),
                ('analisis', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='vete.Analisis')),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s_o_l', models.DecimalField(decimal_places=2, max_digits=5)),
                ('GR', models.DecimalField(decimal_places=2, max_digits=5)),
                ('Hb', models.DecimalField(decimal_places=2, max_digits=5)),
                ('plaquetas', models.IntegerField()),
                ('GB', models.DecimalField(decimal_places=2, max_digits=5)),
                ('VCM', models.DecimalField(decimal_places=2, max_digits=5)),
                ('HCM', models.DecimalField(decimal_places=2, max_digits=5)),
                ('ChCM', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ultima_inundacion', models.DateField()),
                ('signos_clinicos', models.CharField(max_length=20)),
        ...
        migrations.AddField(
            ...
            name='sintomas',
            field=models.ManyToManyField(to='vete.Sintoma'),
        ),
        migrations.AddField(
            model_name='canino',
            name='propietario',
